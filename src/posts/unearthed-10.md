...
{% bandcamp 'https://cycliclaw.bandcamp.com/album/lacrimae-mundi-remixed' %}
...
{% bandcamp 'https://winter-light.bandcamp.com/album/the-grey-lake' %}

Amdusias by 72PILLARS is a unique experiment born from the collaboration of nine artists. Each was given a different noise sample and tasked with crafting their own interpretation of Amdusias. The original noise album is [free to download](https://72pillars.bandcamp.com/album/amdusias-the-noise).

{% bandcamp 'https://aneclecticcollectionofdust.bandcamp.com/album/amdusias' %}
...
{% bandcamp 'https://cryochamber.bandcamp.com/album/narcomancer' %}
...
{% bandcamp 'https://the-black-monolith.bandcamp.com/album/the-bull-of-phalaris' %}
...
{% bandcamp 'https://cryochamber.bandcamp.com/album/the-erosion-of-innocence' %}
...
{% bandcamp 'https://cycliclaw.bandcamp.com/album/ac-phale' %}
...
{% mixcloud 'https://www.mixcloud.com/winterlightnl/nacht-radio-show-20112025/' %}

Dark Ambient Soundscapes from The Kult of O:

{% mixcloud 'https://www.mixcloud.com/uurObscuur/dark-ambient-soundscapes/' %}