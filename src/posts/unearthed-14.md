...
tags:
  - post
  - unearthed
date: 2026-02-02t23:00:00.0+01:00
---
# New releases
...
{% bandcamp 'https://eighthtowerrecords.bandcamp.com/album/no-future' %}
...
{% bandcamp 'https://blackweald.bandcamp.com/album/ahtola' %}
...
{% bandcamp 'https://insectarium.bandcamp.com/album/with-wings-removed' %}
...
{% bandcamp 'https://cryochamber.bandcamp.com/album/endless-cold-endless-darkness' %}
...
{% bandcamp 'https://noctilucant.bandcamp.com/album/aconitum-napellus' %}
...
{% bandcamp 'https://winter-light.bandcamp.com/album/sewn-into-the-infinite-sky' %}
...
{% bandcamp 'https://darkodysseyrecords.bandcamp.com/album/a-cold-furnace' %}

By coincidence, we have another album from a Hungarian artist. **Premex Solus**: **Approximation** was released by Zenapolae. Slowly moving drones and found sounds comprise these six long, beautiful tracks. The album is [available for download at Zenapolae](https://www.zenapolae.com/zen323).
...
{% mixcloud 'https://www.mixcloud.com/winterlightnl/empusae-a-winter-light-mix-tape-by-nicolas-van-meirhaeghe/' %}
...
{% mixcloud 'https://www.mixcloud.com/uurObscuur/ethereal-ambient-and-more/' %}

Another great one from Oneirich: Dark Ritual Ambient mixtape:

{% mixcloud 'https://www.mixcloud.com/uurObscuur/dark-ritual-ambient-20260127/' %}
...
{% mixcloud 'https://www.mixcloud.com/winterlightnl/nacht-radio-show-29012026/' %}
